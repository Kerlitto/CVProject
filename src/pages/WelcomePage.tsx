        ...
        <div className="mt-6 flex flex-col gap-8 md:mt-12 md:flex-row md:items-center md:justify-between md:gap-4">
          ...
          <div className="text-xl  md:w-[50%]">
            ...
            <p className="mb-2">
              ...
              filmmaking at TC Video, where I handle film production for various
              events.{" "}
            </p>
            <p className="mb-2">
            ...
            <p className="mb-2">
              ...
              effective international collaboration. I warmly invite you to
              contact me and explore potential collaborations!
            </p>
          </div>
        </div>
      </div>
